  ...
  return (
    <div className="glass-panel p-4 lg:col-span-2 h-80 flex flex-col group border-t-2 border-t-brandBlue transition-all hover:shadow-md">
      <div className="flex justify-between items-center mb-4 border-b border-slate-200 pb-2">
          <h3 className="text-sm font-bold text-slate-900 tracking-widest uppercase flex items-center"><LineChart className="text-brandBlue mr-2 w-5 h-5" /> Global Search Trends</h3>
...
function AEOPanel({ data }) {
  return (
    <div className="glass-panel p-4 lg:col-span-1 flex flex-col group border-t-2 border-t-purple-500 transition-all hover:shadow-md">
      <h3 className="text-sm font-bold text-slate-900 tracking-widest uppercase mb-4 flex items-center border-b border-slate-200 pb-2"><Brain className="text-purple-500 mr-2 w-5 h-5" /> AI Engine Matrix</h3>
...
function RedditPanel({ data }) {
  return (
    <div className="glass-panel p-4 lg:col-span-2 border-t-2 border-t-brandOrange relative overflow-hidden flex flex-col group hover:shadow-md">
        <div className="flex justify-between items-center mb-4 border-b border-slate-200 pb-2">
            <h3 className="text-sm font-bold text-slate-900 tracking-widest uppercase flex items-center"><Radar className="text-brandOrange mr-2 w-5 h-5" /> Lead Radar</h3>
...
function PRPanel({ data }) {
  return (
    <div className="glass-panel p-4 lg:col-span-1 flex flex-col group border-t-2 border-t-red-500 hover:shadow-md">
        <h3 className="text-sm font-bold text-slate-900 tracking-widest uppercase mb-4 flex items-center border-b border-slate-200 pb-2"><Radio className="text-red-500 mr-2 w-5 h-5" /> Network Scraper</h3>
...
function MockAnalyticsPanel({ data }) {
  ...
  return (
    <div className="glass-panel p-4 lg:col-span-2 flex flex-col justify-between group border-t-2 border-t-brandGreen hover:shadow-md">
      <h3 className="text-sm font-bold text-slate-900 tracking-widest uppercase mb-4 flex items-center border-b border-slate-200 pb-2"><ActivitySquare className="text-brandGreen mr-2 w-5 h-5" /> Web Analytics (GA4)</h3>
...
function MockSocialPanel({ data }) {
  ...
  return (
    <div className="glass-panel p-4 lg:col-span-1 flex flex-col justify-between group border-t-2 border-t-brandBlue hover:shadow-md">
      <h3 className="text-sm font-bold text-slate-900 tracking-widest uppercase mb-4 flex items-center border-b border-slate-200 pb-2"><Users className="text-brandBlue mr-2 w-5 h-5" /> Social Engagement</h3>
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="glass-panel p-4 col-span-1 border-t-2 border-t-red-500 group hover:shadow-md">
            <h3 className="text-sm font-bold text-slate-900 tracking-widest uppercase mb-4 flex items-center border-b border-slate-200 pb-2"><Search className="text-red-500 mr-2 w-5 h-5" /> Target Acquisition (Competitors)</h3>
        ...
        <div className="glass-panel p-4 col-span-1 border-t-2 border-t-brandBlue group hover:shadow-md">
            <h3 className="text-sm font-bold text-slate-900 tracking-widest uppercase mb-4 flex items-center border-b border-slate-200 pb-2"><ActivitySquare className="text-brandBlue mr-2 w-5 h-5" /> System Diagnostics</h3>
